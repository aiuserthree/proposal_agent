...
## 10a. PART 3 서술·레퍼런스 이미지 (`writing-style` §1.1d · `proposal-structure` §18)

- PART 3는 **표·키워드 나열만**으로 끝내지 않는다. **3.0 또는 3.1**에 경영진용 **한 줄 메시지**(Why)를 두고, 각 하위 절에 **문단 2~4개**로 근거·KPI·거버넌스를 서술한다.
- 프로젝트에 `img/`(예: `kb/`, `coway/` 등)가 있으면 **전략 축·콘텐츠·UX 방향**에 맞는 슬라이드를 선별해 삽입한다. 마크다운: `![설명](../../img/...)` + *그림 N-M. 벤치마킹 예시. 귀사 RFP·REQ에 맞게 조정.* 
