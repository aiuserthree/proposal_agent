---
name: team-composer
description: 조직 구성/R&R
---
# team-composer

## 1. 목적과 컨텍스트

프로젝트 **조직도·R&R·MM**을 정의한다. `pm-agent`의 PART 4와 연동되며, 국내 SW 사업 **대가 기준** 등급을 참고해 인력을 산출한다.
...
|------|------|------|
| 필수 | WBS·기간 | 예 |
| 필수 | 필요 역할(기획·디자인·FE·BE·QA·PM 등) | 예 |
| 선택 | 고객사 측 조직(의사결정자) | 아니오 |

## 3. 출력 명세

| 항목 | 내용 |
|------|------|
| 경로 | `workspace/drafts/team-rr-{YYYY-MM-DD}.md` |
| 형식 | Mermaid 조직도 + R&R 표 + MM 요약 |

## 4. 단계별 실행 절차 (6단계)

1. 역할 목록을 확정한다.
2. 내·외부 구분을 명시한다.
3. Mermaid로 조직도를 작성한다.
4. RACI 또는 R&R 표를 채운다.
5. 단계별 MM을 배분한다.
6. 핵심 인력 프로필(경력·자격)을 요약한다.

## 5. 품질 기준

1. 의사결정·승인 주체가 명확.
2. 단일 책임(Single Owner) 원칙 위반 없음.
3. 수치(인원·MM)가 **일정·예산**과 일관.
4. RFP 요구 인력资격 반영.
5. 표 1개 + 다이어그램 1개 이상.
