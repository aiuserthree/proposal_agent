...
시장·소비자·기술·디자인 트렌드를 **출처와 함께** 정리한다. `analyst`의 **PART 2.1~2.2**에 직접 편입되며, `writing-style`에 따라 PART 2 전체 **표 5개 이상** 가운데 **시장·트렌드** 근거를 담당한다. **기술·플랫폼 / UX·전환 / 운영·데이터** 3축 이상으로 나누어 표를 만든다.
...
1. 출처 **3개 이상** 서로 다른 근원.
2. 수치는 **연도·단위** 명시.
3. 트렌드 **3개 이상 영역**(시장/기술/디자인/운영·데이터 등) — PART 2.2의 **3축 분리**와 정합.
4. 각 트렌드에 **귀사 제안 연결** 문장 또는 표 열.
5. 제안서에 붙일 수 있는 한 문단 요약.
6. 환각 방지: 출처 없는 수치 사용 금지.
